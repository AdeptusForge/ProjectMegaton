...
protected:
	...
	AkForceInline void* ReAlloc(void* in_pCurrent, size_t in_uOldSize, size_t in_uNewSize) { in_uOldSize;  return AK_PLUGIN_REALLOC(m_pAllocator, in_pCurrent, in_uNewSize); }
